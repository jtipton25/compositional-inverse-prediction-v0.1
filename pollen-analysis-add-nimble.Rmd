...
if (file.exists(here::here("model-fit", "fit-bummer-pollen.RData"))) {
  ## Load MCMC run
  load(here::here("model-fit", "fit-bummer-pollen.RData"))
} else {
  ...
  save(samples.fit, file=here::here("model-fit", "fit-bummer-pollen.RData"))
}
```
...
for (model_name in models) {
  if (!file.exists(here::here("model-fit", paste0("dm-mvgp-cv-pollen-", 
    ...
    CV_out <- sfSapply(1:kfold, makeCV, model_name=model_name, y_cv=y_cv,
                       ...
                       folds=folds, data_source="pollen")
    if (model_name == "MVGP") {
      ## end timing
      sink(here::here("model-fit", "progress", "cross-validate", 
    ...
    if (model_name == "BUMMER") {
      ## end timing
      sink(here::here("model-fit", "progress", "cross-validate", 
                "dm-cv-bummer-pollen.txt"), append = TRUE)
      print(Sys.time() - start)
      sink()
    }
